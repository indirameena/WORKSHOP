<?php 
	...
	if(!empty($_GET)) {
		$editRecord = [];
		$sql = "SELECT * from workshop_detail where id = " . $_GET["id"];
		$queryStatus = mysqli_query($connection, $sql);

		if($row = mysqli_fetch_assoc($queryStatus)){
			$editRecord = $row;
		} 
	}
	...
	if(!empty($_POST)){
		...
		$sql = "UPDATE workshop_detail SET title = '$title', start_date = '$start_date', end_date = '$end_date', start_time = '$start_time', end_time = '$end_time', technology = '$technology', ws_description = '$ws_description' where id = " . $_GET["id"];
...
<form action="" method="post">
	<div class="form-group">
		...
		<input class=" form-control" type="text" name="title" id="title" required value="<?php echo $editRecord["title"]; ?>">
	</div>

	<div class="form-group">
		<label>Start Date</label>
		<input class="form-control" type="text" required name="start_date" id="start_date" value="<?php echo $editRecord["start_date"]; ?>">
	</div>

	<div class="form-group">
		<label>End Date</label>
		<input class="form-control " type="text" required name="end_date" id="end_date" value="<?php echo $editRecord["end_date"]; ?>">
	</div>

	<div class="form-group">
		<label>Start Time</label>
		<input class="form-control" type="text" required name="start_time" id="start_time" value="<?php echo $editRecord["start_time"]; ?>">
	</div>

	<div class="form-group">
		<label>End Time</label>
		<input class="form-control " type="text" required name="end_time" id="end_time" value="<?php echo $editRecord["end_time"]; ?>">
	</div>

	<div class="form-group">
		<label>Technology</label>
		<input class="form-control " type="text" required name="technology" id="technology" value="<?php echo $editRecord["technology"]; ?>">
	</div>

	<div class="form-group">
		<label>WorkShop Description</label>
		<textarea id="ws_description" class="form-control" required name="ws_description"> <?php echo $editRecord["ws_description"]; ?> </textarea>
	</div>
